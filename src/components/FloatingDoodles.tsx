...
const doodles: DoodleConfig[] = [
  ...
  },
  {
    ...
    animation: { type: 'pulse', duration: 2, delay: 0.9 },
  },
  {
    id: 'stopwatch-left',
    Component: Stopwatch,
    position: { top: '8%', left: '28%' },
    animation: { type: 'float', duration: 3.2, delay: 0.5 },
  },
  {
    id: 'star-left-2',
    Component: Star,
    position: { top: '68%', left: '24%' },
    animation: { type: 'pulse', duration: 1.5, delay: 1.2 },
  },
  {
    id: 'target-left',
    Component: Target,
    position: { bottom: '22%', left: '20%' },
    animation: { type: 'pulse', duration: 2.5, delay: 0.8 },
  },
  // Center column - spread out (38-58%)
  {
    id: 'dumbbell-center',
    Component: Dumbbell,
  ...
  },
  {
    ...
    animation: { type: 'pulse', duration: 1.6, delay: 0.7 },
  },
  // Right side
  {
    id: 'gains-text',
  ...
  },
  {
    ...
    animation: { type: 'pulse', duration: 1.8, delay: 1.0 },
  },
]
